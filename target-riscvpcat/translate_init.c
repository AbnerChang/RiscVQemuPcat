...
struct riscv_def_t {
    ...
    uint64_t machine_mode_init_status_reg;
};
...
static const riscv_def_t riscv_defs[] =
{
    {  
        ...
        .machine_mode_init_status_reg = CSR_MACHINE_MSTATUS_IE_ENABLE | (RISCV_MACHINE_MODE_PRIVILEGE << CSR_MACHINE_MSTATUS_PRV_POS),
    },
};
